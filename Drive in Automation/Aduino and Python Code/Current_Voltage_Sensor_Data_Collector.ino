...
ACS712 currentSensor(A1, 5.0, 1023, 100); // Adjust parameters according to your ACS712 version
...
voltageSensor.setSensitivity(senstivityValue); float voltageNow
...
Serial.println(senstivityValue, 10);// Current sensor calibration current
Sensor.autoMidPoint(); 
...
// Measure AC current
float currentNow = currentSensor.mA_AC_sampling() / 1000.0; //Convert from mA to A
// Calculate the power 
